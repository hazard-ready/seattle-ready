# Generated by Django 4.0.7 on 2022-09-30 22:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='snugget',
            name='FireWUI_2021_220914_filter',
            field=models.IntegerField(null=True),
        ),
        migrations.AddField(
            model_name='snugget',
        ...
        migrations.CreateModel(
            name='Flood100yr500yr_2020_220907',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lookup_val', models.CharField(max_length=80)),
                ('geom', django.contrib.gis.db.models.fields.MultiPolygonField(srid=4326)),
                ('group', models.ForeignKey(default=disasterinfosite.models.Flood100yr500yr_2020_220907.getGroup, on_delete=django.db.models.deletion.PROTECT, to='disasterinfosite.shapefilegroup')),
            ],
        ),
        migrations.CreateModel(
            name='FireWUI_2021_220914',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rast', django.contrib.gis.db.models.fields.RasterField(srid=4326)),
                ('bbox', django.contrib.gis.db.models.fields.PolygonField(srid=4326)),
                ('group', models.ForeignKey(default=disasterinfosite.models.FireWUI_2021_220914.getGroup, on_delete=django.db.models.deletion.PROTECT, to='disasterinfosite.shapefilegroup')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='snugget',
            name='Flood100yr500yr_2020_220907_filter',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='disasterinfosite.flood100yr500yr_2020_220907'),
        ),
        migrations.AddField(
            model_name='snugget',
